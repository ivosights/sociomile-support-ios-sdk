...
extension Date {
    ...
    func isInLastMonth(_ date: Date) -> Bool {
        return Calendar.current.component(.month, from: self) == date.month
    }
    ...
    /// This is used to convert type date with format to string
    /// - Parameters:
    ///   - format: Format date make to specify format
